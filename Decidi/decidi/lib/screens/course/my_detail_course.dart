...
class MyDetailCourse extends StatefulWidget {
  final String idCourse;

  const MyDetailCourse(this.idCourse, {Key? key}) : super(key: key);
  @override
  _MyDetailCourseState createState() => _MyDetailCourseState();
}

class _MyDetailCourseState extends State<MyDetailCourse> {
