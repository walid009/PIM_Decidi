...
class _BookCarState extends State<BookCar> {
  ...
  Future<bool> fetchCar() async {
    http.Response response =
        await http.get(Uri.parse(baseUrl + "/car/" + widget.idCar.toString()));
                ...
                children: [
                  ...
                  Center(
                    child: ElevatedButton(
                      onPressed: () {
                        http
                            .patch(Uri.parse(baseUrl +
                                "/car/update/" +
                                widget.idCar.toString()))
                            .then((response) {
                            ...
                            http
                              ...
                              car = Car(
                                  "http://10.0.2.2:8000/images/" +
                                      carsFromServer["image"],
                                  carsFromServer["marque"],
                                  carsFromServer["model"],
                                  carsFromServer["description"],
                                  int.parse(
                                      carsFromServer["quantity"].toString()));
                              setState(() {});
                            });
                          } else {
                            print("error server : " +
