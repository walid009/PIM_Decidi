...
class DisplayMyTextScience extends StatefulWidget {
  final List<MyData> bacGradesData;
  final String type;

  const DisplayMyTextScience(this.bacGradesData, this.type, {Key? key})
      : super(key: key);

  @override
  _DisplayMyTextScienceState createState() => _DisplayMyTextScienceState();
}

class _DisplayMyTextScienceState extends State<DisplayMyTextScience> {
