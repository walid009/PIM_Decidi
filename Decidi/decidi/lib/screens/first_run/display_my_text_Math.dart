...
class DisplayMyTextMath extends StatefulWidget {
  final List<MyData> bacGradesData;
  final String type;

  const DisplayMyTextMath(this.bacGradesData, this.type, {Key? key})
      : super(key: key);

  @override
  _DisplayMyTextMathState createState() => _DisplayMyTextMathState();
}

class _DisplayMyTextMathState extends State<DisplayMyTextMath> {
  ...
  void initState() {
    ...
    if (widget.bacGradesData.length == 11) {
      mathematique.text = widget.bacGradesData[0].x;
      physique.text = widget.bacGradesData[1].x;
      science.text = widget.bacGradesData[2].x;
