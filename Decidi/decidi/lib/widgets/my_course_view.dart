...
import '../screens/course/detail_course.dart';
import '../screens/course/my_detail_course.dart';
...
class MyCourseView extends StatelessWidget {
  ...
  MyCourseView(this.id, this.image, this.title, this.price, {Key? key})
      : super(key: key);
        ...
        onTap: () async {
          Navigator.of(context).push(
            MaterialPageRoute<void>(
              builder: (BuildContext context) => MyDetailCourse(id),
            ),
          );
        },
        child: Container(
